...
import Rol_Header from './Rol/routes/Rol_headers.routes'
import Rol_Jornadas from './Rol/routes/Rol_jornadas.routes'
import Rol_calendarios  from './Rol/routes/rol_calendario.routes';
import SaveRouter from './Cargar_Archivos/routes/aplicacion.routes'
import Rol_archivos from './Rol/routes/rol_archivos.routes'
...
app.use(Rol_Header)
app.use(Rol_Jornadas)
app.use(Rol_calendarios)
app.use(Rol_archivos)
