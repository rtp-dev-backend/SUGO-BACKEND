...
import { getCalendario, getCalendario_ecosYcreds, getCalendarios, getCalendariosByCred, getRutaDeEco, postCalendario, postCalendarioByExcel } from '../../Rol/controllers/rol_calendarios.controller';
...
routes.get('/api/rol/eco-:eco/ruta',        getRutaDeEco)
